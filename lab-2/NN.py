...
# handle input data
def handleData(
    population: list, vehicle: list, 
    roadarea: list, passengertraffic: list,
    freighttraffic: list
    ):
...
def createModel(
    ...
    ax.set_yticklabels([u'10−2', u'10−1', u'101', u'102', str(('%.4f' % np.power(10, minerr)))])
